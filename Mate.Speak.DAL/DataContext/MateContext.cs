...
public partial class MateContext : DbContext
{
    ...
    public virtual DbSet<AdminSala> AdminSalas { get; set; }

    public virtual DbSet<Calificacion> Calificacions { get; set; }

    public virtual DbSet<CategoriaSala> CategoriaSalas { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminSala>(entity =>
        {
            ...
            entity.HasOne(d => d.IdSalaNavigation).WithMany(p => p.AdminSalas)
                .HasForeignKey(d => d.IdSala)
                .HasConstraintName("FK_admin_salas_idiomas");

            entity.HasOne(d => d.IdSala1).WithMany(p => p.AdminSalas)
                .HasForeignKey(d => d.IdSala)
        ...
        modelBuilder.Entity<Dato>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCalificacionNavigation).WithMany(p => p.Datos)
                .HasForeignKey(d => d.IdCalificacion)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_datos_calificacion");

            entity.HasOne(d => d.IdInteresNavigation).WithMany(p => p.Datos)
                .HasForeignKey(d => d.IdInteres)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_datos_intereses");

            entity.HasOne(d => d.IdPaisNavigation).WithMany(p => p.Datos)
            ...
            entity.HasOne(d => d.NativoNavigation).WithMany(p => p.Datos)
        ...
        modelBuilder.Entity<Estudio>(entity =>
        {
            ...
            entity.HasOne(d => d.IdIdiomaNavigation).WithMany(p => p.Estudios)
                .HasForeignKey(d => d.IdIdioma)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_estudios_idiomas");

            entity.HasOne(d => d.IdNivelNavigation).WithMany(p => p.Estudios)
                .HasForeignKey(d => d.IdNivel)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_estudios_niveles");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Estudios)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Grupo>(entity =>
        {
            ...
            entity.HasOne(d => d.CreadorNavigation).WithMany(p => p.Grupos)
                .HasForeignKey(d => d.Creador)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_grupos_usuarios");

            entity.HasOne(d => d.IdIdiomaNavigation).WithMany(p => p.Grupos)
                .HasForeignKey(d => d.IdIdioma)
        ...
        modelBuilder.Entity<Participante>(entity =>
        {
            ...
            entity.HasOne(d => d.IdGrupoNavigation).WithMany(p => p.Participantes)
        ...
        modelBuilder.Entity<Sala>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCalificacionNavigation).WithMany(p => p.Salas)
                .HasForeignKey(d => d.IdCalificacion)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_salas_calificacion");

            entity.HasOne(d => d.IdCategoriasalaNavigation).WithMany(p => p.Salas)
                .HasForeignKey(d => d.IdCategoriasala)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_salas_categoria_sala");

            entity.HasOne(d => d.IdUsuarioCreadorNavigation).WithMany(p => p.Salas)
